...
Public Class ChangePasswordModel
    ...
    <Required()> _
    <StringLength(100, ErrorMessage:="The {0} must be at least {2} characters long.", MinimumLength:=3)> _
    <DataType(DataType.Password)> _
...
Public Class CreateUserModel
    ...
    <Display(Name:="Add User to Role")>
    Public Property AddUserToRole() As String
        Get
            Return roleValue
        End Get
        Set(ByVal value As String)
