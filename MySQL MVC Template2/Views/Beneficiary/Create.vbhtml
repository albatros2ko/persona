        ...
        <div class="account-settings">
            <div class="row" style="margin-top: 3em;">
                <div class="seven columns">
                    <h5>Add Beneficiary of @ViewData("member_id")</h5>
                    @Using Html.BeginForm()
                        @Html.ValidationSummary(True, "Addition of Beneficiary's record was unsuccessful. Please correct the errors and try again.")
                        @<div Class="input">
                             <div Class="row" style="display: none">
                                 @Html.TextBoxfor(Function(m) m.member_id, New With {Key .text = ViewData("member_id")})
